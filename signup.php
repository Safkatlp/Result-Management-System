...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $select = "SELECT * FROM `tblusers` WHERE user = '$user';";
    $result = mysqli_query($con,$select);
    $num =  mysqli_num_rows($result);

    if($num == 1){
        $userexist = true;
        $alert_message = "<strong>Error!</strong> User Already Exists";

    }else{
        
    
        if( ($pass == $cpass) && $userexist == false){

            $insert = "INSERT INTO `tblusers` (`user`, `password`) VALUES ('$user', '$pass');";
            ...
            $pass_error = true;
            $alert_message = "<strong>Error!</strong> Password not matched";
        }
    }
  ...
  ?>
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="container contactBG p-1 mb-1">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner ">
                                <div class="carousel-item active">
                                    <img src="image/contact_Carosoul/theMongers.jpg" class="img-fluid" alt="...">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid px-2 px-md-5 bg-black  text-center  ">

        <div class="container">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-0 my-0 ">
                <div class="col-md-4 d-flex align-items-center">
                    <a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
                        <img src="image/footer_logo/theMongers.jpg" width="100px" height="80px" class="img-fluid"
                            alt="...">
                    </a>
                </div>
                ...
                <ul class="nav col-md-4 justify-content-end list-unstyled d-flex ">
                    <li class="ms-3"><a class="text-muted" href="#"><svg class="bi footerSvgFill" width="24"
                                height="24">
                    ...
                    <li class="ms-3"><a class="text-muted" href="https://www.facebook.com/The.Mongers"><svg
                                class="bi footerSvgFill" width="24" height="24">
